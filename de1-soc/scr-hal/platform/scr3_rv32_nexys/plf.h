...
#ifndef PLATFORM_SCR3_RV32_NEXYS_H
#define PLATFORM_SCR3_RV32_NEXYS_H
...
/*
// 4-entry MPU optimized memory map
#define PLF_MEM_MAP                                                   \
    {PLF_MMCFG_BASE, PLF_MMCFG_SIZE, PLF_MMCFG_ATTR, PLF_MMCFG_NAME}, \
    {PLF_MMIO_BASE, PLF_MMIO_SIZE, PLF_MMIO_ATTR, PLF_MMIO_NAME},     \
    {0, EXPAND32ADDR(0xffffffff), PLF_MEM_ATTR, PLF_MEM_NAME}
*/
...
#endif // PLATFORM_SCR3_RV32_NEXYS_H
