...
#ifndef PLATFORM_SCR7_L3_H
#define PLATFORM_SCR7_L3_H
...
#define PLF_CLUSTER_RESET_CORES (1)
...
#define PLF_MEM_BASE           (0x400000000ULL)
#define PLF_MEM_SIZE           (2ULL*1024ULL*1024ULL*1024ULL)
#define PLF_MEM_ATTR           (SCR_PMP_CTRL_MT_WEAKLY | PMP_RWX)
#define PLF_MEM_NAME           "DDR_P0"

#define PLF_CLUSTER_CFG_BASE   (0x04000000UL)
#define PLF_CLUSTER_CFG_SIZE   (0x8000UL)
#define PLF_CLUSTER_CFG_ATTR   (SCR_PMP_CTRL_MT_STRONG | \
                                PMP_R |                  \
                                PMP_W)
...
#define PLF_MMIO_BASE          (0x1E000000ULL)
#define PLF_MMIO_SIZE          (0x00200000ULL)
#define PLF_MMIO_ATTR          (SCR_PMP_CTRL_MT_STRONG | \
                                PMP_R |                  \
                                PMP_W)
#define PLF_MMIO_NAME          "MMIO"

#define PLF_MMIO2_BASE         (0xC000000ULL)
#define PLF_MMIO2_SIZE         (0x0100000ULL)
#define PLF_MMIO2_ATTR         (SCR_PMP_CTRL_MT_STRONG | \
                                PMP_R |                  \
                                PMP_W)
#define PLF_MMIO2_NAME         "MMIO2"

#define PLF_MMIO3_BASE         (0xF000000ULL)
#define PLF_MMIO3_SIZE         (0x0100000ULL)
#define PLF_MMIO3_ATTR         (SCR_PMP_CTRL_MT_STRONG | \
                                PMP_R |                  \
                                PMP_W)
#define PLF_MMIO3_NAME         "MMIO3"

#define PLF_OCRAM_BASE         (0x02000000UL)
#define PLF_OCRAM_SIZE         (64UL*1024UL)
#define PLF_OCRAM_ATTR         (SCR_PMP_CTRL_MT_WEAKLY | PMP_RWX)
#define PLF_OCRAM_NAME         "On-Chip RAM"

#if PLF_ICCM_L3_SUPPORT
// Support for new ICCM
#define PLF_ICCM_BASE          (0x04020000UL)
#define PLF_ICCM_SIZE          (8UL*1024UL)
#define PLF_ICCM_ATTR          (SCR_PMP_CTRL_MT_STRONG | \
                                PMP_R |                  \
                                PMP_W)
...
#define PLF_MEM_MAP                                                                           \
    ...
    {PLF_MMIO2_BASE, PLF_MMIO2_SIZE, PLF_MMIO2_ATTR, PLF_MMIO2_NAME, PLF_DEFAULT_MPORT},      \
    {PLF_MMIO3_BASE, PLF_MMIO3_SIZE, PLF_MMIO3_ATTR, PLF_MMIO3_NAME, PLF_DEFAULT_MPORT},      \
...
// FPGA build ID
#define PLF_BLD_ID_ADDR (PLF_MMIO2_BASE)

// FPGA sysclk, MHz
#define PLF_SYSCLK_MHZ_ADDR (PLF_MMIO2_BASE + 0x1000)
...
// FPGA UART port
#define PLF_UART0_BASE  (PLF_MMIO_BASE + 0x140000UL)
#define PLF_UART0_16550

// external interrupt lines
#define PLF_INTLINE_UART0   (60)

#endif // PLATFORM_SCR7_L3_H
